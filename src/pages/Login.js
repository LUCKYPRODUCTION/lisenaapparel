            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        sonner_1.toast.success('Login berhasil');
                        navigate('/dashboard');
                    }
                    return [2 /*return*/];
            }
    ...
    var handleForgotPassword = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!email) {
                        sonner_1.toast.warning('Masukkan email terlebih dahulu');
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        sonner_1.toast.success('Link reset password telah dikirim ke email Anda');
                    }
                    return [2 /*return*/];
            }
        });
    }); };
    return (<div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
