...
var AuthContext = (0, react_1.createContext)({ user: null, profile: null, loading: true });
var AuthProvider = function (_a) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var listener = supabase_1.supabase.auth.onAuthStateChange(function (_event, session) {
            var _a;
        ...
        return function () { return listener === null || listener === void 0 ? void 0 : listener.subscription.unsubscribe(); };
    }, []);
    var fetchProfile = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
        var data;
    ...
    return (<AuthContext.Provider value={{ user: user, profile: profile, loading: loading }}>
      {children}
